...
function ViewerLayout({
  ...
  // const rightBottomPanelComponents = rightBottomPanels.map(getPanelData);
  // const verticalPanelComponents = verticalHPPanel.map(getPanelData);
  // const topPanelComponents = topPanels.map(getPanelData)
  const bottomPanelComponents = bottomPanels.map(getPanelData)
      ...
      >
        ...
        <div className="flex flex-col flex-1 h-full">
          ...
          <ErrorBoundary>
            <TopBottomPanel
              side="bottom"
              defaultComponentOpen={bottomPanelComponents[0].name}
              childComponents={bottomPanelComponents}
            />
          </ErrorBoundary>
        </div>
          ...
          <ErrorBoundary context="Right Panel">
            <div className="flex flex-col">
              ...
              {/* <div className='h-full'>
                <SidePanel
                  side="right"
                  defaultComponentOpen={rightBottomPanelComponents[0].name}
                  childComponents={rightBottomPanelComponents}
                />
              </div> */}
            </div>
          </ErrorBoundary>
