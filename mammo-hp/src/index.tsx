...
import viewPosition from './custom-attribute/viewPosition';
import imageLaterality from './custom-attribute/imageLaterality';
...
export default {
  ...
  preRegistration: ({
    ...
    HangingProtocolService.addCustomAttribute('ViewPosition', 'ViewPosition', viewPosition);
    HangingProtocolService.addCustomAttribute('ImageLaterality', 'ImageLaterality', imageLaterality);
  },
  /**
